...
git add .  si tu veux indexer les modifications : (ajout modifications ou suppression)\
git commit -m "commentaire" : pour le versionnement \
git push : envoie de commit d'un depot local vers depot distant (pusher le commit)
